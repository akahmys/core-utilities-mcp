...
2. The user is reconsidering whether the remaining 14 tools all belong under "core utilities." `execute_command_in_sandbox` was scrutinized and kept (see AWU 7.4) as intentionally load-bearing rather than in-scope-by-accident. No further tool has been flagged yet.
